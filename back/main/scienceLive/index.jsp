...
<head>
        ...
        $(function(){
            layui.use(['element', 'form', 'table'], function(){
                ...
                var theTable = table.render({
                    elem: '#demo',
                    url: '${ctx}/backActivity/list/0/all',
                    width:900,
                    // data:[{
                    //     'rank':'1',
                    //     'name':'小米',
                    ...
                    cols: [[
                        ...
                        },
                        {
                            ...
                            align: 'center',
                            templet: function(d){
                                var newTime = getTime(d.ctime)
                                return '<div style="text-align: center">'+ newTime +'</div>'
                            }
                        },
                        {
                            field: 'score',
    ...
    <!--id="videoType"模块用于将表格中的视频分类的数字转成对应的文字-->
    <script type="text/html" id="videoTypeName">

        {{#  if(d.videoType == 1){ }}
        <div>SELF·Kids</div>
        {{# }else if(d.videoType == 2){ }}
        <div>科学</div>
        {{# }else if(d.videoType == 3){ }}
        <div>技术</div>
        {{# }else if(d.videoType == 4){ }}
        <div>工程</div>
        {{# }else if(d.videoType == 5){ }}
        <div>艺术</div>
        {{# }else if(d.videoType == 6){ }}
        <div>数学</div>
        {{# }else if(d.videoType == 7){ }}
        <div>其他</div>
        {{# } }}
        ...
        <div class="nav-f">
            <div class="layui-tab" lay-filter="demo">
                <ul class="layui-tab-title">
                    <li style="font-size: 16px;margin-left: 10px">科学直播课</li>
                </ul>
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <a href="${ctx}/backMenu/scienceLiveAdd?id=0" style="display: none" id="jump"> </a>
                        <div class="button">
